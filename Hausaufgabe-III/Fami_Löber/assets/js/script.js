...
fetch(url)
	...
	.then((rep) => {
		try {
			...
			function getData() {
				if (value === "M") {
					return `<div class="M"><img src="/Hausaufgabe-II/Fami_Löber/assets/img/Richie.jpg" /></div>`;
				}
			}

			appendValues(getColumn(7));
