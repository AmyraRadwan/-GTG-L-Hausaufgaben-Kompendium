...
function appendValues(values = [], appendToObj = "output", wrapperClass = "wrapper") {
	...
	// Alle Elemente mit der Klasse 'c3' auswählen
let c3Elements = document.getElementsByClassName("c3");
